        ...
        <div class="card">
            ...
            <td class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div>
                        <table cellspacing="0" cellpadding="0" id="Table1" style="table-layout:fixed"
                               class="admintable03 table table-condensed table-bordered table-hover table-striped"
                               onmouseover="overShow(this,event)" onmouseout="outHide()">
                            <thead>
                            <tr>
                                <style>
                                    table {
                            ...
                            <tr>
                                ...
                                <td style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis;">
                                    《仲夏夜之夢》，是威廉·莎士比亞在約1590年－1596年間創作的浪漫喜劇。它描繪了以雅典大公忒修斯和希波呂忒婚禮為中心的一系列故事。包括四名​​雅典戀人和六個業餘演員的冒險經歷，而森林裡的仙子們則在背後操作它們的命運。本戲劇是莎士比亞最流行的劇本之一，在全世界都有上演。
                                </td>
                                <td>1</td>
                                <td>2021-01-03</td>
                                <td>100/100</td>
                            ...
                            <tr>
                                ...
                                <td style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis;">
                                    ...
                                    《哈姆雷特》是莎士比亚所有戏剧中篇幅最长的一部， [1]
                                    也是莎士比亚最负盛名的剧本，具有深刻的悲剧意义。复杂的人物性格以及丰富完美的悲剧艺术手法，代表着整个西方文艺复兴时期文学的最高成就。同《麦克白》、《李尔王》和《奥赛罗》一起组成莎士比亚“四大悲剧”。
                                </td>
                                <td>1</td>
                                <td>2021-01-04 </td>
                                <td>1/1</td>
