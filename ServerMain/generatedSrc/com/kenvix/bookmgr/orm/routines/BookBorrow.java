...
public class BookBorrow extends AbstractRoutine<java.lang.Void> {
     ...
     */
    public static final Parameter<Long> BOOK_ID_V = Internal.createParameter("book_id_v", SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>book_borrow.borrower_uid_v</code>.
     */
    public static final Parameter<Long> BORROWER_UID_V = Internal.createParameter("borrower_uid_v", SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>book_borrow.expected_returned_at_v</code>.
     */
    public static final Parameter<Timestamp> EXPECTED_RETURNED_AT_V = Internal.createParameter("expected_returned_at_v", SQLDataType.TIMESTAMP(0), false, false);
