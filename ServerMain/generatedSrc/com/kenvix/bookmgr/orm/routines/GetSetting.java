...
public class GetSetting extends AbstractRoutine<String> {
     ...
     */
    public static final Parameter<String> KEY_V = Internal.createParameter("key_v", SQLDataType.VARCHAR(30), false, false);

    /**
     * Create a new routine call instance
     */
    public GetSetting() {
        super("get_setting", DefaultSchema.DEFAULT_SCHEMA, SQLDataType.CLOB);
