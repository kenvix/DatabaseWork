...
public class TruncateArchiveTable extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = -917033010;

    /**
     * The parameter <code>truncate_archive_table.table_name</code>.
     */
    public static final Parameter<String> TABLE_NAME = Internal.createParameter("table_name", org.jooq.impl.SQLDataType.VARCHAR(100), false, false);
