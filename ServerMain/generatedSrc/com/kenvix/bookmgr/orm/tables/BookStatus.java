...
public class BookStatus extends TableImpl<BookStatusRecord> {
    ...
    private static final long serialVersionUID = 1739639828;
     ...
     */
    public final TableField<BookStatusRecord, Byte> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "");

    /**
     * The column <code>book_status.description</code>.
     */
    public final TableField<BookStatusRecord, String> DESCRIPTION = createField(DSL.name("description"), org.jooq.impl.SQLDataType.VARCHAR(10), this, "");
