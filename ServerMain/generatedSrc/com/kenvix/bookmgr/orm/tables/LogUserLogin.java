...
public class LogUserLogin extends TableImpl<LogUserLoginRecord> {
    ...
    private static final long serialVersionUID = -541463461;
     ...
     */
    public final TableField<LogUserLoginRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>log_user_login.uid</code>. 用户UID
     */
    public final TableField<LogUserLoginRecord, Long> UID = createField(DSL.name("uid"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "用户UID");

    /**
     * The column <code>log_user_login.time</code>. 登录时间
     */
    public final TableField<LogUserLoginRecord, Timestamp> TIME = createField(DSL.name("time"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "登录时间");

    /**
     * The column <code>log_user_login.ip</code>. 登录IP
     */
    public final TableField<LogUserLoginRecord, String> IP = createField(DSL.name("ip"), org.jooq.impl.SQLDataType.VARCHAR(45).nullable(false), this, "登录IP");

    /**
     * The column <code>log_user_login.useragent</code>. 用户代理
     */
    public final TableField<LogUserLoginRecord, String> USERAGENT = createField(DSL.name("useragent"), org.jooq.impl.SQLDataType.CLOB, this, "用户代理");
    ...
    public Identity<LogUserLoginRecord, Long> getIdentity() {
        return Keys.IDENTITY_LOG_USER_LOGIN;
    }
