...
public class Setting extends TableImpl<SettingRecord> {
     ...
     */
    public final TableField<SettingRecord, String> VALUE = createField(DSL.name("value"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>setting.description</code>.
     */
    public final TableField<SettingRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>setting.type</code>. 类型
     */
    public final TableField<SettingRecord, String> TYPE = createField(DSL.name("type"), SQLDataType.CHAR(6).nullable(false), this, "类型");
