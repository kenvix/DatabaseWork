...
public class Publisher extends TableImpl<PublisherRecord> {
     ...
     */
    public final TableField<PublisherRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "出版社ID");

    /**
     * The column <code>publisher.name</code>. 出版社名称
     */
    public final TableField<PublisherRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(80).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "出版社名称");

    /**
     * The column <code>publisher.description</code>. 出版社简介
     */
    public final TableField<PublisherRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.CLOB, this, "出版社简介");
