...
public class BookBorrowForAdminRecord extends TableRecordImpl<BookBorrowForAdminRecord> implements Record9<Long, String, Long, Timestamp, Timestamp, Timestamp, String, String, Short>, IBookBorrowForAdmin {

    private static final long serialVersionUID = -1441514557;
    ...
    @Override
    public Row9<Long, String, Long, Timestamp, Timestamp, Timestamp, String, String, Short> valuesRow() {
    ...
    @Override
    public BookBorrowForAdminRecord value9(Short value) {
        setRenewNum(value);
        return this;
    }

    @Override
    public BookBorrowForAdminRecord values(Long value1, String value2, Long value3, Timestamp value4, Timestamp value5, Timestamp value6, String value7, String value8, Short value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BookBorrowForAdminRecord(Long bookId, String bookTitle, Long borrowerUid, Timestamp borrowedAt, Timestamp expectedReturnedAt, Timestamp actualReturnedAt, String borrowerRealName, String borrowerSerialId, Short renewNum) {
        super(BookBorrowForAdmin.BOOK_BORROW_FOR_ADMIN);
