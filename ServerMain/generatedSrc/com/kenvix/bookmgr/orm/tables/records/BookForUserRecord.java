...
public class BookForUserRecord extends TableRecordImpl<BookForUserRecord> implements Record14<Long, String, String, Long, Timestamp, Integer, Integer, Byte, String, Long, String, String, String, Long>, IBookForUser {

    private static final long serialVersionUID = 1878100334;
    ...
    @Override
    public Row14<Long, String, String, Long, Timestamp, Integer, Integer, Byte, String, Long, String, String, String, Long> valuesRow() {
    ...
    @Override
    public BookForUserRecord values(Long value1, String value2, String value3, Long value4, Timestamp value5, Integer value6, Integer value7, Byte value8, String value9, Long value10, String value11, String value12, String value13, Long value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BookForUserRecord(Long id, String title, String description, Long publisherId, Timestamp createdAt, Integer numTotal, Integer numAvailable, Byte status, String publisherName, Long authorId, String authorName, String authorFullname, String authorCountry, Long creatorUid) {
        super(BookForUser.BOOK_FOR_USER);
