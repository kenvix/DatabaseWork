...
public class BookRecord extends UpdatableRecordImpl<BookRecord> implements Record10<Long, Long, Integer, String, String, Long, Timestamp, Integer, Integer, Byte>, IBook {

    private static final long serialVersionUID = -1362428260;
    ...
    @Override
    public Row10<Long, Long, Integer, String, String, Long, Timestamp, Integer, Integer, Byte> valuesRow() {
    ...
    @Override
    public BookRecord values(Long value1, Long value2, Integer value3, String value4, String value5, Long value6, Timestamp value7, Integer value8, Integer value9, Byte value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BookRecord(Long id, Long creatorUid, Integer typeId, String title, String description, Long publisherId, Timestamp createdAt, Integer numTotal, Integer numAvailable, Byte status) {
        super(Book.BOOK);
