...
public class SettingRecord extends UpdatableRecordImpl<SettingRecord> implements Record3<String, String, String>, ISetting {

    private static final long serialVersionUID = -564012547;
    ...
    @Override
    public SettingRecord values(String value1, String value2, String value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public SettingRecord(String key, String value, String description) {
        super(Setting.SETTING);
