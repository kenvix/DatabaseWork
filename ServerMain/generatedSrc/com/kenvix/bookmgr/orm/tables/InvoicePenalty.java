...
public class InvoicePenalty extends TableImpl<InvoicePenaltyRecord> {
     ...
     */
    public final TableField<InvoicePenaltyRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>invoice_penalty.invoice_id</code>. 订单ID
     */
    public final TableField<InvoicePenaltyRecord, Long> INVOICE_ID = createField(DSL.name("invoice_id"), SQLDataType.BIGINT.nullable(false), this, "订单ID");

    /**
     * The column <code>invoice_penalty.book_id</code>. 书籍ID
     */
    public final TableField<InvoicePenaltyRecord, Long> BOOK_ID = createField(DSL.name("book_id"), SQLDataType.BIGINT.nullable(false), this, "书籍ID");
    ...
    public Identity<InvoicePenaltyRecord, Long> getIdentity() {
        return (Identity<InvoicePenaltyRecord, Long>) super.getIdentity();
    }
