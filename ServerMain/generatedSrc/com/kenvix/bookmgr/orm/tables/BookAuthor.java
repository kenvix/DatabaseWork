...
public class BookAuthor extends TableImpl<BookAuthorRecord> {
     ...
     */
    public final TableField<BookAuthorRecord, Long> BOOK_ID = createField(DSL.name("book_id"), SQLDataType.BIGINT.nullable(false), this, "书籍ID");

    /**
     * The column <code>book_author.author_id</code>. 作者ID
     */
    public final TableField<BookAuthorRecord, Long> AUTHOR_ID = createField(DSL.name("author_id"), SQLDataType.BIGINT.nullable(false), this, "作者ID");

    /**
     * The column <code>book_author.author_name</code>. 作者通用名称，有索引，可重名
     */
    public final TableField<BookAuthorRecord, String> AUTHOR_NAME = createField(DSL.name("author_name"), SQLDataType.VARCHAR(35).nullable(false), this, "作者通用名称，有索引，可重名");

    /**
     * The column <code>book_author.author_fullname</code>. 作者全名
     */
    public final TableField<BookAuthorRecord, String> AUTHOR_FULLNAME = createField(DSL.name("author_fullname"), SQLDataType.VARCHAR(60).nullable(false), this, "作者全名");

    /**
     * The column <code>book_author.author_country</code>. 作者国籍，使用
ISO 3166-1二位字母代码规范
     */
    public final TableField<BookAuthorRecord, String> AUTHOR_COUNTRY = createField(DSL.name("author_country"), SQLDataType.CHAR(2), this, "作者国籍，使用\r\nISO 3166-1二位字母代码规范");

    /**
     * The column <code>book_author.author_description</code>. 作者简述
     */
    public final TableField<BookAuthorRecord, String> AUTHOR_DESCRIPTION = createField(DSL.name("author_description"), SQLDataType.CLOB, this, "作者简述");
    ...
    private BookAuthor(Name alias, Table<BookAuthorRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `book_author` as "));
    }
