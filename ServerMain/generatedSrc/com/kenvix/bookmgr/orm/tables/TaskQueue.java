...
public class TaskQueue extends TableImpl<TaskQueueRecord> {
     ...
     */
    public final TableField<TaskQueueRecord, Timestamp> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.TIMESTAMP(0).nullable(false), this, "");

    /**
     * The column <code>task_queue.finished_at</code>.
     */
    public final TableField<TaskQueueRecord, Timestamp> FINISHED_AT = createField(DSL.name("finished_at"), SQLDataType.TIMESTAMP(0), this, "");

    /**
     * The column <code>task_queue.is_finished</code>.
     */
    public final TableField<TaskQueueRecord, Boolean> IS_FINISHED = createField(DSL.name("is_finished"), SQLDataType.BIT.nullable(false).defaultValue(DSL.inline("b'0'", SQLDataType.BIT)), this, "");

    /**
     * The column <code>task_queue.is_success</code>.
     */
    public final TableField<TaskQueueRecord, Boolean> IS_SUCCESS = createField(DSL.name("is_success"), SQLDataType.BIT.nullable(false).defaultValue(DSL.inline("b'0'", SQLDataType.BIT)), this, "");

    /**
     * The column <code>task_queue.is_doing</code>.
     */
    public final TableField<TaskQueueRecord, Boolean> IS_DOING = createField(DSL.name("is_doing"), SQLDataType.BIT.nullable(false), this, "");

    /**
     * The column <code>task_queue.type</code>.
     */
    public final TableField<TaskQueueRecord, Short> TYPE = createField(DSL.name("type"), SQLDataType.SMALLINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.SMALLINT)), this, "");

    /**
     * The column <code>task_queue.content</code>. 任务正文（程序可读）
     */
    public final TableField<TaskQueueRecord, JSON> CONTENT = createField(DSL.name("content"), SQLDataType.JSON, this, "任务正文（程序可读）");

    /**
     * The column <code>task_queue.result</code>. 任务结果（程序可读）
     */
    public final TableField<TaskQueueRecord, JSON> RESULT = createField(DSL.name("result"), SQLDataType.JSON, this, "任务结果（程序可读）");
