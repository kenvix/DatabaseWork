...
public class BookBorrow extends TableImpl<BookBorrowRecord> {
     ...
     */
    public final TableField<BookBorrowRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>book_borrow.book_id</code>. 书籍ID
     */
    public final TableField<BookBorrowRecord, Long> BOOK_ID = createField(DSL.name("book_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "书籍ID");

    /**
     * The column <code>book_borrow.borrower_uid</code>. 借书人UID
     */
    public final TableField<BookBorrowRecord, Long> BORROWER_UID = createField(DSL.name("borrower_uid"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "借书人UID");

    /**
     * The column <code>book_borrow.borrowed_at</code>. 借书日期
     */
    public final TableField<BookBorrowRecord, Timestamp> BORROWED_AT = createField(DSL.name("borrowed_at"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "借书日期");

    /**
     * The column <code>book_borrow.expected_returned_at</code>. 期望的还书日期
     */
    public final TableField<BookBorrowRecord, Timestamp> EXPECTED_RETURNED_AT = createField(DSL.name("expected_returned_at"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "期望的还书日期");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.BOOK_BORROW_FK_BOOK_ID, Indexes.BOOK_BORROW_FK_BORROWER_UID);
    }
