...
public class LogSystem extends TableImpl<LogSystemRecord> {
     ...
     */
    public final TableField<LogSystemRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>log_system.source</code>. 日志来源
     */
    public final TableField<LogSystemRecord, String> SOURCE = createField(DSL.name("source"), SQLDataType.VARCHAR(50).nullable(false), this, "日志来源");

    /**
     * The column <code>log_system.level</code>. 日志级别
     */
    public final TableField<LogSystemRecord, LogSystemLevel> LEVEL = createField(DSL.name("level"), SQLDataType.VARCHAR(7).nullable(false).asEnumDataType(com.kenvix.bookmgr.orm.enums.LogSystemLevel.class), this, "日志级别");

    /**
     * The column <code>log_system.time</code>. 发生事件
     */
    public final TableField<LogSystemRecord, Timestamp> TIME = createField(DSL.name("time"), SQLDataType.TIMESTAMP(0).nullable(false), this, "发生事件");

    /**
     * The column <code>log_system.message</code>. 消息
     */
    public final TableField<LogSystemRecord, String> MESSAGE = createField(DSL.name("message"), SQLDataType.CLOB.nullable(false), this, "消息");

    /**
     * The column <code>log_system.exception</code>. 日志异常类型（简化名）
     */
    public final TableField<LogSystemRecord, String> EXCEPTION = createField(DSL.name("exception"), SQLDataType.VARCHAR(20), this, "日志异常类型（简化名）");
    ...
    public Identity<LogSystemRecord, Long> getIdentity() {
        return (Identity<LogSystemRecord, Long>) super.getIdentity();
    }
