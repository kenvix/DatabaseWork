...
public class Invoice extends TableImpl<InvoiceRecord> {
    ...
    private static final long serialVersionUID = -413964288;
     ...
     */
    public final TableField<InvoiceRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "订单ID");

    /**
     * The column <code>invoice.name</code>. 订单名称
     */
    public final TableField<InvoiceRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "订单名称");

    /**
     * The column <code>invoice.type</code>. 订单类型
     */
    public final TableField<InvoiceRecord, Short> TYPE = createField(DSL.name("type"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "订单类型");

    /**
     * The column <code>invoice.owner_uid</code>. 付款人UID
     */
    public final TableField<InvoiceRecord, Long> OWNER_UID = createField(DSL.name("owner_uid"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "付款人UID");

    /**
     * The column <code>invoice.should_pay</code>. 应付金额
     */
    public final TableField<InvoiceRecord, Integer> SHOULD_PAY = createField(DSL.name("should_pay"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "应付金额");

    /**
     * The column <code>invoice.created_at</code>. 创建时间
     */
    public final TableField<InvoiceRecord, Timestamp> CREATED_AT = createField(DSL.name("created_at"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>invoice.status</code>. 订单状态
     */
    public final TableField<InvoiceRecord, Byte> STATUS = createField(DSL.name("status"), org.jooq.impl.SQLDataType.TINYINT.nullable(false), this, "订单状态");

    /**
     * The column <code>invoice.expire_at</code>. 订单过期时间
     */
    public final TableField<InvoiceRecord, Timestamp> EXPIRE_AT = createField(DSL.name("expire_at"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("2038-01-19 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "订单过期时间");

    /**
     * The column <code>invoice.paid_at</code>. 订单支付时间,NULL为没付
     */
    public final TableField<InvoiceRecord, Timestamp> PAID_AT = createField(DSL.name("paid_at"), org.jooq.impl.SQLDataType.TIMESTAMP, this, "订单支付时间,NULL为没付");

    /**
     * The column <code>invoice.comment</code>. 订单备注
     */
    public final TableField<InvoiceRecord, String> COMMENT = createField(DSL.name("comment"), org.jooq.impl.SQLDataType.CLOB, this, "订单备注");

    /**
     * The column <code>invoice.extra_data</code>. 保留备用。特定订单驱动可读的数据信息
     */
    public final TableField<InvoiceRecord, JSON> EXTRA_DATA = createField(DSL.name("extra_data"), org.jooq.impl.SQLDataType.JSON, this, "保留备用。特定订单驱动可读的数据信息");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.INVOICE_FK_INVOCIE_STATUS, Indexes.INVOICE_FK_OWNER_UID, Indexes.INVOICE_FK_TYPE);
    }
