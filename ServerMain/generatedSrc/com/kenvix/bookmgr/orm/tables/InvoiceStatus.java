...
public class InvoiceStatus extends TableImpl<InvoiceStatusRecord> {
     ...
     */
    public final TableField<InvoiceStatusRecord, Byte> ID = createField(DSL.name("id"), SQLDataType.TINYINT.nullable(false), this, "");

    /**
     * The column <code>invoice_status.description</code>.
     */
    public final TableField<InvoiceStatusRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.VARCHAR(10).nullable(false), this, "");
