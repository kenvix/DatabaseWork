...
public class BookAuthorMap extends TableImpl<BookAuthorMapRecord> {
    ...
    private static final long serialVersionUID = -1267272300;
     ...
     */
    public final TableField<BookAuthorMapRecord, Long> BOOK_ID = createField(DSL.name("book_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "书籍ID");

    /**
     * The column <code>book_author_map.author_id</code>. 作者ID
     */
    public final TableField<BookAuthorMapRecord, Long> AUTHOR_ID = createField(DSL.name("author_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "作者ID");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.BOOK_AUTHOR_MAP_FK_BOOK_AUTHOR_MAP_AUTHOR_ID);
    }
