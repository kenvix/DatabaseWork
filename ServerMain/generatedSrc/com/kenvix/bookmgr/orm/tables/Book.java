...
public class Book extends TableImpl<BookRecord> {
     ...
     */
    public final TableField<BookRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "书本ID");

    /**
     * The column <code>book.creator_uid</code>. 条目创建者UID
     */
    public final TableField<BookRecord, Long> CREATOR_UID = createField(DSL.name("creator_uid"), SQLDataType.BIGINT.nullable(false), this, "条目创建者UID");

    /**
     * The column <code>book.type_id</code>. 图书类型ID
     */
    public final TableField<BookRecord, Integer> TYPE_ID = createField(DSL.name("type_id"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("0", SQLDataType.INTEGER)), this, "图书类型ID");

    /**
     * The column <code>book.title</code>. 书籍标题
     */
    public final TableField<BookRecord, String> TITLE = createField(DSL.name("title"), SQLDataType.VARCHAR(120).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "书籍标题");

    /**
     * The column <code>book.description</code>. 书籍概述
     */
    public final TableField<BookRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.CLOB.nullable(false), this, "书籍概述");
     ...
     */
    public final TableField<BookRecord, Timestamp> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.TIMESTAMP(0).nullable(false).defaultValue(DSL.inline("0000-00-00 00:00:00", SQLDataType.TIMESTAMP)), this, "条目创建时间");

    /**
     * The column <code>book.num_total</code>. 书籍总数
     */
    public final TableField<BookRecord, Integer> NUM_TOTAL = createField(DSL.name("num_total"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("1", SQLDataType.INTEGER)), this, "书籍总数");

    /**
     * The column <code>book.num_available</code>. 可用书籍数
     */
    public final TableField<BookRecord, Integer> NUM_AVAILABLE = createField(DSL.name("num_available"), SQLDataType.INTEGER.nullable(false), this, "可用书籍数");

    /**
     * The column <code>book.isbn</code>. 国际标准书号 (International Standard Book Number)
     */
    public final TableField<BookRecord, String> ISBN = createField(DSL.name("isbn"), SQLDataType.VARCHAR(40).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "国际标准书号 (International Standard Book Number)");

    /**
     * The column <code>book.status</code>. 书籍状态
     */
    public final TableField<BookRecord, Byte> STATUS = createField(DSL.name("status"), SQLDataType.TINYINT.nullable(false), this, "书籍状态");
