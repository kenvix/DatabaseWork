...
public class UserExtra extends TableImpl<UserExtraRecord> {
     ...
     */
    public final TableField<UserExtraRecord, Long> UID = createField(DSL.name("uid"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
     ...
     */
    public final TableField<UserExtraRecord, Long> CARD_SERIAL_ID = createField(DSL.name("card_serial_id"), org.jooq.impl.SQLDataType.BIGINT, this, "卡片序列号");

    /**
     * The column <code>user_extra.start_year</code>. 入学(职)年份
     */
    public final TableField<UserExtraRecord, Short> START_YEAR = createField(DSL.name("start_year"), org.jooq.impl.SQLDataType.SMALLINT, this, "入学(职)年份");

    /**
     * The column <code>user_extra.department</code>. 所在部门
     */
    public final TableField<UserExtraRecord, String> DEPARTMENT = createField(DSL.name("department"), org.jooq.impl.SQLDataType.VARCHAR(20), this, "所在部门");

    /**
     * The column <code>user_extra.comment</code>. 备注
     */
    public final TableField<UserExtraRecord, String> COMMENT = createField(DSL.name("comment"), org.jooq.impl.SQLDataType.CLOB, this, "备注");
