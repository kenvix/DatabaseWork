...
public class BookType extends TableImpl<BookTypeRecord> {
    ...
    private static final long serialVersionUID = 836992583;
     ...
     */
    public final TableField<BookTypeRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "图书类目ID");

    /**
     * The column <code>book_type.name</code>. 类目名称
     */
    public final TableField<BookTypeRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "类目名称");

    /**
     * The column <code>book_type.parent_id</code>. 父级图书类目ID
     */
    public final TableField<BookTypeRecord, Integer> PARENT_ID = createField(DSL.name("parent_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "父级图书类目ID");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.BOOK_TYPE_FK_BOOK_TYPE_PARENT_ID);
    }

    @Override
    public Identity<BookTypeRecord, Integer> getIdentity() {
        return Keys.IDENTITY_BOOK_TYPE;
    }
