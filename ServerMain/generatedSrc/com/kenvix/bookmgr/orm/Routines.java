...
public class Routines {
     ...
     */
    public static void bookAuthorMapDelete(
     ...
     */
    public static Long bookBorrow(
          Configuration configuration
        , Long bookIdV
        , Long borrowerUidV
        , Timestamp expectedReturnedAtV
    ) {
     ...
     */
    public static Timestamp bookBorrowRenew(
          Configuration configuration
        , Long borrowId
    ) {
     ...
     */
    public static void bookBorrowReturn(
          Configuration configuration
        , Long borrowId
     ...
     */
    public static Integer bookBorrowUnreturnedNum(
          Configuration configuration
        , Long borrowerUid
    ) {
     ...
     */
    public static Field<Integer> bookBorrowUnreturnedNum(
          Long borrowerUid
    ) {
        BookBorrowUnreturnedNum f = new BookBorrowUnreturnedNum();
        f.setBorrowerUid(borrowerUid);
     ...
     */
    public static Boolean bookBorrowerHasExpired(
          Configuration configuration
        , Long userUid
    ) {
     ...
     */
    public static Field<Boolean> bookBorrowerHasExpired(
          Long userUid
    ) {
        BookBorrowerHasExpired f = new BookBorrowerHasExpired();
        f.setUserUid(userUid);
     ...
     */
    public static Field<String> getSetting(
          String keyV
    ) {
        GetSetting f = new GetSetting();
        f.setKeyV(keyV);
     ...
     */
    public static void truncateArchiveTable(
          Configuration configuration
        , String tableName
    ) {
